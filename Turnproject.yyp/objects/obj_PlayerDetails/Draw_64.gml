...
draw_text(text_x + 20, current_y, "Name: " + player.weapon_name);
current_y += line_height;
...
// === CONTROLS ===
draw_set_color(c_yellow);
draw_text(text_x, viewport_h - 75, "CONTROLS:");
draw_set_color(c_white);
draw_text(text_x, viewport_h - 60, "ESC - Close this window");
draw_text(text_x, viewport_h - 45, "0-9 - Switch weapons");
if (array_length(player_list) > 1) {
    draw_set_color(c_ltgray);
