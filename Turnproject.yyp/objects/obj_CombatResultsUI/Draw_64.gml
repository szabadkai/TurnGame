...
draw_set_color(combat_result == "victory" ? c_ltgray : c_gray);
draw_set_alpha(ui_alpha);
...
// Draw return button
var current_button_color = button_hover ? c_ltgray : c_gray;
...
// Button text
draw_set_color(button_hover ? c_black : c_white);
draw_set_halign(fa_center);
draw_set_valign(fa_middle);
