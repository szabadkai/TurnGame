...
if (variable_global_exists("combat_log")) {
    global.combat_log("UI Manager initialized");
    global.combat_log("PlayerDetails found: " + string(player_details != noone));
    global.combat_log("LevelUpOverlay found: " + string(level_up_overlay != noone));
}
...
function show_player_details(player) {
    ...
    if (variable_global_exists("combat_log")) {
        global.combat_log("UI Manager: Showing player details for " + player.character_name);
    }
...
function show_level_up_overlay(player) {
    ...
    if (variable_global_exists("combat_log")) {
        global.combat_log("UI Manager: Showing level-up overlay for " + player.character_name);
    }
